window.PROBLEMS = [
  ...
  {
    "id": "DBX-QSQL-001",
    "title": "Find users with 7 consecutive active days.",
    "category": "SQL",
    "difficulty": "Medium",
    "priority": "P1",
    "runtime": "rubric",
    "prompt": "Find users with 7 consecutive active days.",
    "starter": "",
    "setup": "",
    "expected": [],
    "testCode": "",
  ...
  {
    "id": "DBX-QSQL-003",
    "title": "Return files whose size is above the 95th percentile per team.",
    "category": "SQL",
    "difficulty": "Medium",
    "priority": "P1",
    "runtime": "rubric",
    "prompt": "Return files whose size is above the 95th percentile per team.",
    "starter": "",
    "setup": "",
    "expected": [],
    "testCode": "",
  ...
  {
    "id": "DBX-QSQL-004",
    "title": "Find the second most recent upload per user.",
    "category": "SQL",
    "difficulty": "Medium",
    "priority": "P1",
    "runtime": "rubric",
    "prompt": "Find the second most recent upload per user.",
    "starter": "",
    "setup": "",
    "expected": [],
    "testCode": "",
  ...
  },
  {
    ...
    "priority": "P1",
    "runtime": "rubric",
    "prompt": "Detect schema drift from event payload key counts.",
    "starter": "",
    "setup": "",
    "expected": [],
    "testCode": "",
  ...
  {
    "id": "DBX-QSQL-007",
    "title": "Build a query for net new paid teams by month.",
    "category": "SQL",
    "difficulty": "Medium",
    "priority": "P1",
    "runtime": "rubric",
    "prompt": "Build a query for net new paid teams by month.",
    "starter": "",
    "setup": "",
    "expected": [],
    "testCode": "",
  ...
  {
    "id": "DBX-QSQL-009",
    "title": "Compute median upload size per platform.",
    "category": "SQL",
    "difficulty": "Medium",
    "priority": "P1",
    "runtime": "rubric",
    "prompt": "Compute median upload size per platform.",
    "starter": "",
    "setup": "",
    "expected": [],
    "testCode": "",
  ...
  {
    "id": "DBX-QSQL-010",
    "title": "Identify teams with declining active seats for three straight months.",
    "category": "SQL",
    "difficulty": "Medium",
    "priority": "P1",
    "runtime": "rubric",
    "prompt": "Identify teams with declining active seats for three straight months.",
    "starter": "",
    "setup": "",
    "expected": [],
    "testCode": "",
  ...
  {
    "id": "DBX-QSQL-002",
    "title": "Compute month-1, month-2, and month-3 retention by signup cohort.",
    "category": "SQL",
    "difficulty": "Medium",
    "priority": "P2",
    "runtime": "rubric",
    "prompt": "Compute month-1, month-2, and month-3 retention by signup cohort.",
    "starter": "",
    "setup": "",
    "expected": [],
    "testCode": "",
  ...
  {
    "id": "DBX-QSQL-005",
    "title": "Compute cumulative storage usage per team by day.",
    "category": "SQL",
    "difficulty": "Medium",
    "priority": "P2",
    "runtime": "rubric",
    "prompt": "Compute cumulative storage usage per team by day.",
    "starter": "",
    "setup": "",
    "expected": [],
    "testCode": "",
  ...
  {
    "id": "DBX-QSQL-008",
    "title": "Find users who shared files but never uploaded.",
    "category": "SQL",
    "difficulty": "Medium",
    "priority": "P2",
    "runtime": "rubric",
    "prompt": "Find users who shared files but never uploaded.",
    "starter": "",
    "setup": "",
    "expected": [],
    "testCode": "",
